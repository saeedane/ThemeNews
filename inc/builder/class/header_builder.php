...
class HeaderBuilder {
	...
	public function register_customizer_settings( WP_Customize_Manager $wp_customize ) {
		...
		require_once get_template_directory() . '/inc/builder/customizer/general-config.php';
		require_once get_template_directory() . '/inc/builder/customizer/footer-config.php';
	...
	public function save_header_builder() {
		...
		if ( ! empty( $builder_settings ) ) {
			...
			if ( ! empty( $current_settings ) ) {
				$builder_settings = wp_parse_args( $builder_settings, $current_settings );
			}
