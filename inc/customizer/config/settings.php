...
class Customizer {
	...
	public function load_script() {
		wp_enqueue_style( 'soledad-fw-customizer-redirect', get_parent_theme_file_uri( 'inc/customizer/framework/assets/css/admin/theme-customizer.css' ) );
		wp_enqueue_style( 'vex', get_parent_theme_file_uri( 'inc/customizer/framework/assets/css/admin/vex.css' ) );
		wp_enqueue_script( 'vex', get_parent_theme_file_uri( 'inc/customizer/framework/assets/js/admin/vex.combined.min.js' ), array( 'jquery' ), null, true );
	}
