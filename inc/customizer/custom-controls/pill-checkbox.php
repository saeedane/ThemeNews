...
class Penci_Pill_Checkbox_Custom_Control extends WP_Customize_Control {
	/**
	...
	public function enqueue() {
		wp_enqueue_script( 'penci-custom-controls-js', get_template_directory_uri() . '/inc/customizer/js/customizer.js', array(
			'jquery',
			'jquery-ui-core'
		), '1.1', true );
		wp_enqueue_style( 'penci-custom-controls-css', get_template_directory_uri() . '/inc/customizer/css/customizer.css', array(), '1.0', 'all' );
	}
	...
	public function render_content() {
        ...
        <div class="pill_checkbox_control">
            ...
            <input type="hidden" id="<?php echo esc_attr( $this->id ); ?>" name="<?php echo esc_attr( $this->id ); ?>"
                   ...
                   class="customize-control-sortable-pill-checkbox" <?php $this->link(); ?> />
