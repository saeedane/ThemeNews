	...
	public function render_meta_box_content( $post ) {
		...
		<?php if ( in_array( $post_type, $post_type_allow ) ) { ?>
            ...
            <div class="pcmt-control-wrapper">
                ...
                <div class="pcmt-control">
                    <p><input placeholder="Enter the custom post reading time" id="penci_reading_time" name="penci_reading_time" type="text"
		...
		<?php if ( in_array( $post_type, $post_type_allow ) ) { ?>
            ...
            <div class="pcmt-control-wrapper">
                ...
                <div class="pcmt-control">
                    <p><input placeholder="Enter the custom aspect ratio here" id="_customize-input-penci_pfeatured_image_ratio" name="penci_pfeatured_image_ratio"
