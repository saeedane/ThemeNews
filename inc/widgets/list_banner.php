...
<div class="penci-list-banner">
	...
	if ( $crop && ! $height ): echo ' penci-banner-crop'; endif; ?>"<?php if ( $crop && ! $height ) {
		...
		if ( $crop && ! $height ): echo ' penci-banner-crop'; endif; ?>"<?php if ( $crop && ! $height ) {
			...
			<?php if ( ! $crop ): ?>
				<?php if ( ! get_theme_mod( 'penci_disable_lazyload_layout' ) ) { ?>
                    <img class="penci-lazy" src="<?php echo penci_holder_image_base(); ?>"
                         data-src="<?php echo do_shortcode( $img1 ); ?>" alt="Promotion Image">
				<?php } else { ?>
		...
		if ( $crop && ! $height ): echo ' penci-banner-crop'; endif; ?>"<?php if ( $crop && ! $height ) {
			...
			if ( $crop && ! $height ): echo ' penci-banner-crop'; endif; ?>"<?php if ( $crop && ! $height ) {
				...
				<?php if ( ! $crop ): ?>
					<?php if ( ! get_theme_mod( 'penci_disable_lazyload_layout' ) ) { ?>
                        <img class="penci-lazy" src="<?php echo penci_holder_image_base(); ?>"
                             data-src="<?php echo do_shortcode( $img2 ); ?>" alt="Promotion Image">
					<?php } else { ?>
			...
			if ( $crop && ! $height ): echo ' penci-banner-crop'; endif; ?>"<?php if ( $crop && ! $height ) {
				...
				if ( $crop && ! $height ): echo ' penci-banner-crop'; endif; ?>"<?php if ( $crop && ! $height ) {
					...
					<?php if ( ! $crop ): ?>
						<?php if ( ! get_theme_mod( 'penci_disable_lazyload_layout' ) ) { ?>
                            <img class="penci-lazy" src="<?php echo penci_holder_image_base(); ?>"
                                 data-src="<?php echo do_shortcode( $img3 ); ?>" alt="Promotion Image">
						<?php } else { ?>
